...
public class HealingBoostEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("create_cogs_invaders_healing_boost", item -> Ingredient.of(new ItemStack(CreateCogsInvadersModItems.MEDKIT.get())).test(new ItemStack(item)));

	public HealingBoostEnchantment() {
