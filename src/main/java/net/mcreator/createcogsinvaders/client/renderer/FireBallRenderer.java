...
public class FireBallRenderer extends EntityRenderer<FireBallEntity> {
	private static final ResourceLocation texture = new ResourceLocation("create_cogs_invaders:textures/entities/fire_ball.png");
	private final Modelsturdy_pellet model;

	public FireBallRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelsturdy_pellet(context.bakeLayer(Modelsturdy_pellet.LAYER_LOCATION));
	}
