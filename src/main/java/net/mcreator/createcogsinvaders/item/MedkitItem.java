...
public class MedkitItem extends Item {
	...
	public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
		if (Screen.hasShiftDown()) {
			...
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.medkit.shift_down_0"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.medkit.shift_down_1"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.space.shift_down"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.right_click.shift_down"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.medkit.shift_down_2"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.right_click_entity.shift_down"));
			p_41423_.add(Component.translatable("tooltip.create_cogs_invaders.medkit.shift_down_3"));
		} else {
