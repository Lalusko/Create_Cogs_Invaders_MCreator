...
import net.mcreator.createcogsinvaders.procedures.HSBlockstatesProcedure;
import net.mcreator.createcogsinvaders.init.CreateCogsInvadersModBlocks;
import org.jetbrains.annotations.Nullable;

import java.util.List;

public class HealingStationBlock extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		HSBlockstatesProcedure.execute(world, x, y, z, blockstate, entity);
	...
	public void appendHoverText(ItemStack p_49816_, @Nullable BlockGetter p_49817_, List<Component> p_49818_, TooltipFlag p_49819_) {
		if (Screen.hasShiftDown()) {
			...
			p_49818_.add(Component.translatable("tooltip.create_cogs_invaders.healing_station.shift_down_0"));
			...
			p_49818_.add(Component.translatable("tooltip.create_cogs_invaders.healing_station.shift_down_1"));
			p_49818_.add(Component.translatable("tooltip.create_cogs_invaders.armor_repair_station.shift_down_5"));
			p_49818_.add(Component.translatable("tooltip.create_cogs_invaders.healing_station.shift_down_2"));
